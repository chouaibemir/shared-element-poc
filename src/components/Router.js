...
export class Router extends React.Component<RouterProps, RouterState> {
  ...
  normalizeSharedElementsConfig(sharedElementsConfig) {
    if (!sharedElementsConfig || !sharedElementsConfig.length) return;
    return sharedElementsConfig.map(this.normalizeSharedElementConfig);
  }
  ...
  handleAction({action, config, node}: RouterAction) {
    ...
    const sharedElementsConfig = this.normalizeSharedElementsConfig(
